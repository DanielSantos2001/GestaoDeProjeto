                ...
                <table class="headerTable">
                    <tbody>
                        <tr>
                            <td>
                                <a href="#">
                                    <img src="/img/IPC-PRETO.png" class="hidden-phone hidden-tablet header-normal"
                                        border="0">
                                ...
                                <table>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="hidden-phone">
                                                <span
                                                    class="hidden-tablet">{{ Session::get('username') }}&nbsp;|&nbsp;</span>
                                            </td>
                                            <td>
                                            ...
                                            <td class="hidden-phone">
                                                <span>&nbsp;|&nbsp;</span><a class="navtableGo"
                                                    href="/logout">Sair</a>
                                            </td>
                                            <td class="header-idiomas">
                                                &nbsp;|&nbsp;<span class="selected">PT</span>&nbsp;<a
                                                    href="#">EN</a>&nbsp;
                                            </td>
                                        ...
                                        <ul class="menu-list" style="list-style: none;">
                                            <li>
                                                <a onclick="abrirEcraModalPrivacidade();">
                                                    <span class="hand" id="politicaPrivacidade">Política de
                                                        Privacidade</span>
                                                </a>
                                            </li>
                                        </ul>
