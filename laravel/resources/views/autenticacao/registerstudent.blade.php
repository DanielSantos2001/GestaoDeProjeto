								...
								<td>
									<table class="zonecontent">
										...
										<tr id="trRegisto">
											...
											<td class="cellcontent cellcontentwithinputtext">
												<span id="spanTextPessNome">
													<input type="text" name="pessNome" value="" style="width:80%;" class="inputText">
												</span>
										...
										<tr>
											...
											<td class="cellcontent cellcontentwithinputtext">
												<span id="spanTextPessEmail">
													<input type="text" name="pessEmail" value="" style="width:80%;" class="inputText">
												</span>
										...
										<tr>
											...
											<td class="cellcontent cellcontentwithinputtext">
												<span id="spanPassword">
													<input type="password" name="passwd" value="" style="width:80%;" class="inputText">
												</span>
										...
										<tr>
											...
											<td class="cellcontent cellcontentwithinputtext">
												<span id="spanCheckPassword">
													<input type="password" name="checkPasswd" value="" style="width:80%;" class="inputText">
												</span>
										...
										<tr>
											...
											<td class="cellcontent cellcontentwithinputtext">
											<select name="cursoEscolhido" id="idCurso" class="inputText">
													<option value="1" selected="selected">Sistemas e Tecnologias da Informação</option>
													<option value="2">Engenharia Informática</option>
				...
				<tr>
					<td>
						<table class="zoneformbuttons" style="margin-left: 29%;">
							<tbody><tr id="trBotaoPesquisar">
								<td>
									<span id="spanSubmitTag" style="display:none;"><img src="../images/progressIndicator.svg?v=1643324203147" align="absmiddle">&nbsp;&nbsp;A processar. Por favor aguarde.</span> <input type="submit" value="Registar" onclick="escondeBotoesTagLib(this);" class="button buttonFront">
									<input type="submit" name="org.apache.struts.taglib.html.CANCEL" value="Cancelar" onclick="bCancel=true;" class="button buttonBack">
								</td>
							</tr>
						</tbody></table>
					</td>
