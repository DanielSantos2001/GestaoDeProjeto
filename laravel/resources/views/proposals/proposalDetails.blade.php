...
<tbody>
  <tr>
    ...
    <td class="cellcontentLarge">@if ($proposal->PROP_APPROVED == 0) Pendente  @elseif ($proposal->PROP_APPROVED == 1) Aprovada @else Rejeitada @endif  </td>
...
@if ($proposal->PROP_APPROVED==0)
  ...
  <tr>
    ...
    </form> <!--<a href="#" class="botaodetalhes"><span>Aceitar</span></a>-->
    </td>
    <td rowspan="1" class="zoneLinks">
