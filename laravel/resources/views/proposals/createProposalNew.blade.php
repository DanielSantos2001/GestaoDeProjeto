                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="cellcontent cellcontentwithinputtext">
                                                    <input type="text" id="titulo" name="titulo" style="width:80%;"
                                                        class="inputText">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="cellcontent cellcontentwithinputtext">
                                                        <input type="text" name="emailEmpresa"
                                                            value="{{ Session::get('usermail') }}" id="emailEmpresa"
                                                            style="width:80%;" class="inputText" hidden>
                                                        <input type="text" name="emailEmpresa1"
                                                            value="{{ Session::get('usermail') }}" id="emailEmpresa1"
                                                            style="width:80%;" class="inputText" disabled>
                                                    </td>
                                                </tr>
                                            @else
                                                <tr>
                                                    ...
                                                    <td class="cellcontent cellcontentwithinputtext">
                                                        ...
                                                        @endphp
                                                        <input list="emailEmpresa" name="emailEmpresa" style="width:50%;"
                                                            autocomplete="off" />
                                                        <datalist id="emailEmpresa" name="emailEmpresa">
                                                            @foreach ($mails as $mail)
                                                                <option
                                                                    value="{{ $mail->USER_NAME }} - {{ $mail->USER_MAIL }}">
                                                            @endforeach
                                            ...
                                            <tr>
                                                ...
                                                <td class="cellcontent cellcontentwithinputtext">
                                                    <textarea class="mceContentBody inputText" id="descricao"
                                                        name="descricao" rows="5"
                                                        style="min-width:100px; width:80%; resize:none; "></textarea>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="label">
                                                ...
                                                <td class="cellcontent cellcontentwithinputtext">
                                                    <input type="number" class="form-control" name="vagas" id="vagas"
                                                        aria-describedby="basic-addon1" min="1" step="1" max="20"
                                            ...
                                            <tr>
                                                ...
                                                <td class="cellcontent cellcontentwithinputtext">
                                                    <select name="curso" id="curso" class="inputText">
                                                        <option value="LSTI" selected="selected">Sistemas e Tecnologias da
                                                            Informação</option>
                                                        ...
                                                        <option value="LDROT">Desenvolvimento Regional e Ordenamento do
                                                            Território</option>
                                            ...
                                            <tr>
                                                ...
                                                <td class="cellcontent cellcontentwithinputtext">
                                                    <textarea class="mceContentBody inputText" id="perfil" name="perfil"
                                                        rows="5"
                                                        style="min-width:100px; width:80%; resize:none; "></textarea>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="cellcontent cellcontentwithinputtext">
                                                    <input class="form-control-file" type="file" name="fileSaver[]"
                                                        id="fileSaver" multiple style="width:80%;" accept=".doc,.docx,.pdf">
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="https://simg.nicepng.com/png/small/128-1280406_view-user-icon-png-user-circle-icon-png.png"
                                                        id="prop_img_c" class="img_prop">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: center;">
                                                    <label class="custom-file-upload">
                                                        <input type="file" name="imagecp" id="imagecp"
                                                            style="display: none;" class="custom-file-upload"
                                ...
                                <td class="gea_flex_end">
                                    <table class="zoneformbuttons ">
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <input type="submit" value="Registar" onclick=""
                                                        class="button buttonFront">
                                                    <input type="button" value="Cancelar" onclick="" name="inserir"
