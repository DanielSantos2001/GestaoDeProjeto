                            ...
                            <tr>
                                <td>
                                    <div id="notificacoes">
                                        ...
                                        <p>Não tem estágios</p>

                                        @else
                                        <table style="width: 100%" class="displaytable">
                                            <thead>
                                                <tr>
                                                    <th class="cellheaderleft">Estagio</th>
                                            ...
                                            <tbody>
                                                ...
                                                @if($proposal->PROP_COMPANY_ID == Session::get('id') && $proposal->PROP_APPROVED == 1)
                                                <tr class="lightrow">
                                                    <td class="contentLeft" style="width: 60%">{{$proposal->PROP_TITLE}}</td>
                                                    <td class="contentCenter" style="width: 30%">{{$proposal->PROP_INTERESTED}} Alunos</td>
